...
const VideoPoker = () => {
  ...
  // Game Actions (MODIFICADO con sugerencias automáticas)
  const dealCards = () => {
    if (chips < bet) return;
    ...
    setCards(newCards);
    setHeldCards([false, false, false, false, false]); // Inicialmente nada seleccionado
    setLastWin(0);
    setWinningHand('');
      ...
      setTimeout(() => {
        ...
        if (index === 4) {
          setTimeout(() => {
            ...
            }, 500); // Medio segundo de delay para que el usuario vea las cartas primero
  ...
  const drawCards = () => {
    ...
    setTimeout(() => {
      cardsToReplace.forEach((cardIndex, arrayIndex) => {
        ...
        // Reveal each new card with delay
        setTimeout(() => {
          setCards([...newCards]);
          setRevealedCards(prev => {
            const newRevealed = [...prev];
  ...
  const Card = ({ card, isHeld, onClick, isRevealed = true }) => {
    const cardBack = React.createElement('div', {
      ...
      style: { 
        ...
        backgroundImage: 'url(assets/cartapokermuchacho.png)',
        backgroundSize: 'cover',
        backgroundPosition: 'center',
        backgroundRepeat: 'no-repeat',
        imageRendering: 'crisp-edges' // Mejorar nitidez
      }
    }, [
...
// Interfaz Moderna de Doblar (MODAL + DISEÑO ORIGINAL ESPECTACULAR)
  const ModernDoubleUpScreen = () => {
    return React.createElement('div', {
      ...
      React.createElement('div', {
        key: 'modal-container',
        className: 'relative w-full max-w-5xl max-h-screen overflow-y-auto',
        style: {
        ...
        React.createElement('div', {
          ...
          React.createElement('div', {
            key: 'header-bg',
            className: 'bg-black/30 backdrop-blur-lg rounded-3xl p-6 border border-cyan-500/30 mb-8',
            style: {
            ...
            React.createElement('div', {
              ...
              React.createElement('div', {
                key: 'round-info',
                className: 'bg-gradient-to-r from-cyan-500/20 to-blue-500/20 rounded-2xl p-4 border border-cyan-400/30 hover:border-cyan-400/60 transition-all duration-300',
                style: {
              ...
              React.createElement('div', {
                key: 'current-info',
                className: 'bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-2xl p-4 border border-green-400/30 hover:border-green-400/60 transition-all duration-300',
                style: {
              ...
              React.createElement('div', {
                key: 'potential-info',
                className: 'bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-2xl p-4 border border-yellow-400/30 hover:border-yellow-400/60 transition-all duration-300',
                style: {
        ...
        React.createElement('div', {
          key: 'main-game-area',
          className: 'flex flex-col items-center justify-center px-8 pb-8'
        }, [
          ...
          React.createElement('div', {
            ...
            React.createElement('div', {
              key: 'card-glow',
              className: 'absolute inset-0 bg-gradient-to-r from-cyan-500/30 to-purple-500/30 rounded-3xl blur-xl scale-110'
            }),
            React.createElement('div', {
              key: 'main-card',
              ...
              React.createElement('div', {
                ...
                React.createElement('div', {
                  ...
                  className: `absolute inset-0 bg-gradient-to-br from-white to-gray-100 rounded-2xl shadow-2xl border-4 ${doubleUpCard && ['♥', '♦'].includes(doubleUpCard.suit) ? 'border-red-500' : 'border-gray-800'} flex flex-col justify-between p-4`,
                  style: {
                    backfaceVisibility: 'hidden',
                  ...
                  React.createElement('div', {
                    ...
                    className: `text-6xl text-center ${doubleUpCard && ['♥', '♦'].includes(doubleUpCard.suit) ? 'text-red-600' : 'text-black'}`,
                    style: {
                ...
                React.createElement('div', {
                  ...
                  className: 'absolute inset-0 bg-gradient-to-br from-blue-800 to-purple-900 rounded-2xl shadow-2xl border-4 border-cyan-500 flex items-center justify-center',
                  style: {
                    backfaceVisibility: 'hidden',
                    transform: 'rotateY(180deg)',
                  ...
                  React.createElement('div', {
                    key: 'back-pattern',
                    className: 'text-cyan-400 text-6xl opacity-80'
                  }, '⚡')
                ])
              ])
            ])
          ...
          doubleUpFlipping && React.createElement('div', {
            ...
            React.createElement('div', {
              ...
              React.createElement('div', {
                key: 'spinner-ring1',
                className: 'absolute inset-0 border-4 border-cyan-500/30 border-t-cyan-500 rounded-full animate-spin'
              }),
              React.createElement('div', {
                key: 'spinner-ring2',
              ...
              React.createElement('div', {
                key: 'spinner-core',
                className: 'absolute inset-6 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-full animate-pulse'
              })
            ])
          ]),
          ...
          !showDoubleResult && !doubleUpFlipping && React.createElement('div', {
            ...
            React.createElement('button', {
              ...
              className: 'group relative px-12 py-6 bg-gradient-to-r from-red-600 to-red-700 rounded-2xl font-bold text-white text-2xl transition-all duration-300 hover:scale-110 hover:shadow-2xl',
              style: {
                boxShadow: '0 8px 25px rgba(239, 68, 68, 0.4), inset 0 1px 0 rgba(255,255,255,0.2)'
              }
            }, [
            ...
            React.createElement('button', {
              ...
              className: 'group relative px-12 py-6 bg-gradient-to-r from-gray-700 to-gray-800 rounded-2xl font-bold text-white text-2xl transition-all duration-300 hover:scale-110 hover:shadow-2xl',
              style: {
          ...
          React.createElement('button', {
            ...
            onClick: collectWinnings,
            className: 'group relative px-12 py-4 bg-gradient-to-r from-green-600 to-green-700 rounded-2xl font-bold text-white text-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl',
            style: {
          ...
          doubleUpRound >= 5 && React.createElement('div', {
            ...
            className: 'bg-gradient-to-r from-yellow-500/30 to-orange-500/30 border border-yellow-400/50 rounded-2xl p-6 text-yellow-400 font-bold text-xl flex items-center gap-3 mt-8',
            style: {
      ...
      React.createElement('div', {
        ...
        React.createElement('div', {
          ...
          React.createElement('div', {
            ...
            React.createElement('div', {
              key: 'hands',
              className: 'bg-black/70 backdrop-blur-sm px-4 py-2 rounded-xl border border-green-400/30'
            }, [
              React.createElement('span', {
                key: 'hands-text',
